...
type Props = {
  ...
  searchParams?: Promise<{ source?: "Fake" | "Dummy" }>;
};
      ...
      <main className="mt-15 min-md:py-3 min-md:px-6 w-full flex items-center justify-center">
        <div className="min-md:w-3/4 max-md:px-3 w-full">
          <h1 className="mb-3 text-2xl font-bold tracking-widest">
            <span className="text-muted">〢</span>Product Page
          </h1>
          ...
          <section>
            <div className="bg-white rounded shadow-2xs flex max-md:flex-col ring-1 ring-gray-300">
              ...
              <div className="min-md:w-1/2 p-6 flex-1 space-y-4 bg-base">
                ...
                <p className="text-md text-gray-800 tracking-widest uppercase">
                  <span className="font-semibold">Price: </span>
                  <span className="text-[#d4aa7d] font-bold">$</span>
                  {product.price}
                </p>
          ...
          <section className="mt-3">
            <h1 className="mb-3 text-2xl font-bold tracking-widest">
              <span className="text-muted">〢</span>Related Products
            </h1>
